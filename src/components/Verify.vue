<template>
  <div class="relative container mb-10 mt-10">
      ...
      <form @submit.prevent="submitForm">
         ...
         <div class="form-row">
            <div class="input-data">
               <input v-model="user.token" type="text" required id="email" autocomplete="on">
               <div class="underline"></div>
        ...
        <div class="flex justify-center">
         ...
         <div class="form-row flex justify-center submit-btn" @click="verifyAccount()">
        ...
        <div class="flex flex-wrap ms-4 me-4 mt-6 mb-4">
            <div class="w-1/2">
                <a href="#forgot_password" class="text-gray-700 text-lg hover:text-red-500">
                    <small>Didn't receive the token?</small>
                </a>
            </div>
  ...
  methods: {
    verifyAccount() {
      if (this.user.email === "" || this.user.password === "") {
        ...
        this.verify.message = "Please enter your email";
        return;
      }
      ...
      this.$instance.post("/user/verify", this.user, { withCredentials: true , headers: {
        ...
        .then((response) => {
          ...
          this.verify.isVisible = true;
          this.verify.message = "Verification Successful";
          setTimeout(() => {
